...
**Jujutsu Commit Helper skill:**

```yaml  theme={null}
description: Generate descriptive commit messages by analyzing jj diffs. Use when the user asks for help writing commit messages or reviewing staged changes.
```
